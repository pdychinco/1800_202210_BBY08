//Don't really need this page anymore, I moved all the code to data.js
  ...
  db.collection(collection).get()
    .then(snap => {
      ...
      snap.forEach(doc => { //iterate thru each doc
        ...
        newcard.querySelector('.card-image').src = "./images/" + rest_ID + ".jpeg"; //hikes.jpg
...
db.collection('restaurants').where('user', '==', 'userID').get().then((snapshot) => {
  snapshot.docs.forEach(doc => {
    renderRestaurants(doc);
  })
});